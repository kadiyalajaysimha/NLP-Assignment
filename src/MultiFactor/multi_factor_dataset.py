...
# Initializing Separators which we require for few data formats
ANS_SEP = "<ans>"
...
# Loads the data from the file path. Receives data_format and several other arguments as input.
# checks if the data_format is a valid one and raises an exception if data_format is not in any of the below formats:
# ["multi_factor", "top1_q_model","multi_factor_mixqg", "top1_q_model_mixqg","mix_full_answer"]
# [ "q_model_upper", "pet", "pet_mixqg", "fa_model"]
# This class also has several important helper functions.
...
#Generates a .pt file given a json file
def main():
    import argparse
