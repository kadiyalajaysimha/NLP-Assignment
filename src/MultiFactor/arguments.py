...
# This class is used to store the training related arguments required for the trainer.
@dataclass
...
# This class is used to store the model related arguments such as model_name and it's path and tokenizer.
...
# This class is used to store the arguments such as datasets and path to it and many more fields.
