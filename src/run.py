# This file is used to start the training which uses the multi_factor_dataset to load data
# and multi_factor_trainer to train nad finally save the Model after certain number of epochs.
